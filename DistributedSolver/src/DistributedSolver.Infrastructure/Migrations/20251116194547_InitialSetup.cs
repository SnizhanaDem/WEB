        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InputMatrixA = table.Column<string>(type: "text", nullable: false),
                    InputVectorB = table.Column<string>(type: "text", nullable: false),
                    MatrixSize = table.Column<int>(type: "integer", nullable: false),
                    Status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    ProgressPercent = table.Column<int>(type: "integer", nullable: false),
                    ResultVectorX = table.Column<string>(type: "text", nullable: true),
